...
public class MainActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvnivea = (TextView) findViewById(R.id.tvnivev);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://gopestudiante.000webhostapp.com/api_domotica/update_v_app.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(MainActivity6.this, accion, Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MainActivity6.this, "Error. Intente más tarde", Toast.LENGTH_SHORT).show();
                    }
                }) {
